...
def main():
    ...
    print("Moxi stress scatter packet source/emitted: ", packet.source_point_count, " / ", packet.emitted_point_count)
    print("Moxi stress scatter packet instances/batches/bytes: ", packet.instance_count(), " / ", packet.batch_count(), " / ", packet.total_byte_count())
