...
| `pixi run release-check` | pass after `363cae2`; package consumer, 68-test/native/host gate, and clean 30-run full benchmark all completed | the distributable package and release wrapper validate the completed ordered slices |
