...
| Plotting | [`docs/plotting.md`](plotting.md), [`src/moxi_plot/plotting.mojo`](../src/moxi_plot/plotting.mojo), [`src/moxi_plot/plot_marks.mojo`](../src/moxi_plot/plot_marks.mojo), [`src/moxi_plot/plot_point.mojo`](../src/moxi_plot/plot_point.mojo), [`src/moxi_plot/plot_series.mojo`](../src/moxi_plot/plot_series.mojo), [`src/moxi_plot/plot_data.mojo`](../src/moxi_plot/plot_data.mojo), [`src/moxi_plot/plot_spec.mojo`](../src/moxi_plot/plot_spec.mojo), [`src/moxi_plot/plot_spec_names.mojo`](../src/moxi_plot/plot_spec_names.mojo), [`src/moxi_plot/plot_spec_json.mojo`](../src/moxi_plot/plot_spec_json.mojo), [`src/moxi_plot/plot_spec_types.mojo`](../src/moxi_plot/plot_spec_types.mojo), [`src/moxi_plot/plot_runtime.mojo`](../src/moxi_plot/plot_runtime.mojo), [`src/moxi/plot_selection.mojo`](../src/moxi/plot_selection.mojo), [`src/moxi_plot/plot_link.mojo`](../src/moxi_plot/plot_link.mojo), [`src/moxi_plot/plot_view.mojo`](../src/moxi_plot/plot_view.mojo), [`src/moxi/plot_render.mojo`](../src/moxi/plot_render.mojo), [`src/moxi_plot/plot_render_bridge.mojo`](../src/moxi_plot/plot_render_bridge.mojo), [`src/moxi/svg.mojo`](../src/moxi/svg.mojo) |
...
| Capabilities and conversation | [`src/moxi/capability_types.mojo`](../src/moxi/capability_types.mojo), [`src/moxi/capability_bus.mojo`](../src/moxi/capability_bus.mojo), [`src/moxi/json.mojo`](../src/moxi/json.mojo), [`src/moxi/conversation.mojo`](../src/moxi/conversation.mojo) |
| Demo browser | [`docs/demo-browser.md`](demo-browser.md), [`src/moxi_demo/demo_browser.mojo`](../src/moxi_demo/demo_browser.mojo), [`src/moxi_demo/demo_style.mojo`](../src/moxi_demo/demo_style.mojo), [`src/moxi_demo/demo_entry.mojo`](../src/moxi_demo/demo_entry.mojo), [`examples/demo_browser.mojo`](../examples/demo_browser.mojo) |
