...
| `PLOT_GROUPED_BAR` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_STACKED_BAR` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_PIE` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_DONUT` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_LOLLIPOP` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_WATERFALL` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_CANDLESTICK` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_BULLET` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_GANTT` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_SPAN_CHART` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_BEESWARM` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_VIOLIN` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_RIDGELINE` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_NIGHTINGALE` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_POLAR` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_POLAR_BAR` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_RADIALBAR` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_GAUGE` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_RADAR` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_POPULATION_PYRAMID` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_PARALLEL` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_CONTOUR` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_CONTOURF` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_TRICONTOUR` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_CORRPLOT` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_CALENDAR_HEATMAP` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_PUNCHCARD` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_MARIMEKKO` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_FUNNEL` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_BUMP` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_EFFECT_SCATTER` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_ARC_DIAGRAM` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_GRAPH` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_SANKEY` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_SUNBURST` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_TREE` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_TREEMAP` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_BARBS` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_CHORD` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
| `PLOT_STREAMGRAPH` | `moxi.plotting` | provisional | typed plotting data, specification, or runtime |
